...
class AttnLSTM(nn.Module):
    def __init__(self, input_dim, hidden_dim=64, num_layers=1, dropout=0.1, out_steps=10, out_dim=None):
        super().__init__()
...
class TransformerForecast(nn.Module):
    def __init__(self, input_dim, d_model=64, nhead=4, num_layers=3, dim_feedforward=128, dropout=0.1, out_steps=10, out_dim=None):
        super().__init__()
